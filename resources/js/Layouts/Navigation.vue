        ...
        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <template v-if="hasPermission('UserManager')">
                ...
                <div class="mb-4">
                    ...
                    <MyTransition v-for="subSection in subSectionsPorVencer" :key="subSection.id" :transitiondemonstration="showingMembers">
                    ...
                    <MyTransition v-for="subSection in subSectionsPorVencer7" :key="subSection.id" :transitiondemonstration="showingMembers7">
                        <Link class="w-full flex items-center" :href="route('sections.subSection', {subSection: subSection.id})">
