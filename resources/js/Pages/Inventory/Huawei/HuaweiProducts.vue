          ...
          <table class="w-full whitespace-no-wrap">
            ...
            <tbody>
              <tr v-for="item in huawei_products.data" :key="item.id" class="text-gray-700">
                ...
                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm"><div class="w-[200px]">{{ item.anexe_name }}</div></td>
                ...
                <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">{{ (!item.price_guide1 && !item.price_guide2 ? '' : (item.price_guide1 ? "S/. " + item.price_guide1.unit_price.toFixed(2) : "S/. " + item.price_guide2.unit_price.toFixed(2))) }}</td>
