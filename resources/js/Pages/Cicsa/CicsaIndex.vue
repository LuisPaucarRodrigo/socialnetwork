                    ...
                    <thead class="sticky top-0 z-40 ">
                        ...
                        <tr class="border-b bg-gray-50 text-[11px] font-semibold uppercase tracking-wide text-gray-500">
                            ...
                            <th ref="thProjectName"
                                :class="['border-b-2 border-gray-300 bg-gray-100 px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-600', `sticky left-0 z-30`]">
                            ...
                            <th ref="thProjectCode" :style="thStickyStyle.pc_sticky" :class="[`border-b-2 border-gray-300 bg-gray-100 px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-600`]">
                                <div class="flex justify-center">
                                    <p class="">
                                        Código del Proyecto
                                    </p>
                            ...
                            <th :style="thStickyStyle.pcpe_sticky"
                                :class="['border-b-2 border-gray-300 bg-gray-100 px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-600', checkVisibility('Asignación') ? '' : 'border-r-2']">
                                CPE
                            </th>
                            <th v-if="checkVisibility('Asignación')"
                                class="border-b-2  border-gray-300 bg-gray-100 px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-600">
                            ...
                            <th
                                :class="['border-b-2 border-gray-300 bg-gray-100 px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-600', checkVisibility('Conbranza') ? '' : 'border-r-2']">
                                Monto
                            </th>
                            <th v-if="checkVisibility('Cobranza')"
                                class="border-b-2 border-gray-300 bg-gray-100 px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-gray-600">
                    ...
                    <tbody>
                        <tr v-for="item in dataToRender" :key="item.id" class="text-gray-700">
                            ...
                            <td :class="stateClass(item?.cicsa_materials?.some(item => item?.pick_date))"
                                v-if="checkVisibility('Materiales')" class="border-b border-gray-200 px-2 py-2 text-[13px]">
                            ...
                            <td :class="stateClass(item?.cicsa_charge_area?.invoice_number)"
                                v-if="checkVisibility('Cobranza')" class="border-b border-gray-200 px-2 py-2 text-[13px]">
                                <p class="text-gray-900 text-center">
