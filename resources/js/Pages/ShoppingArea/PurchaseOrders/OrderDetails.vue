        ...
        <div class="mb-14">
          ...
          <div class="grid sm:grid-cols-3 gap-4">
            <div class="grid grid-cols-2 gap-2">
              <div class="font-semibold text-gray-600">Fecha límite de compra:</div>
            ...
            <div class="grid grid-cols-2 gap-2">
              <div class="font-semibold text-gray-600">Fecha de estimada de llegada:</div>
              <div class="text-gray-500">
            ...
            <div class="col-start-1 grid grid-cols-2 gap-2">
              ...
              <div class="text-gray-500">
                <span
                  :class="`uppercase inline-flex items-center gap-x-1 py-0 px-3 text-sm rounded-full font-medium ${bgBadget} text-white`">
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <div class="text-gray-500">
                {{ purchase_order.purchase_quote.currency === 'dolar' ? '$' : 'S/.' }}
                {{ (purchase_order.purchase_quote.total_amount).toFixed(2) }}
              </div>
            </div>
          </div>
        </div>
        <div v-if="purchase_order.purchase_quote.purchasing_requests.project" class="mb-14">
          ...
          <div class="grid sm:grid-cols-3 gap-4">
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <div class="text-gray-500">{{
    purchase_order.purchase_quote.purchasing_requests.project?.preproject.customer
  }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="mb-14">
          ...
          <div class="grid sm:grid-cols-3 gap-4">
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <div class="text-gray-500">{{ purchase_order.purchase_quote.provider.company_name }}</div>
            </div>
            <br>
            <div class="grid grid-cols-2 gap-2">
              ...
              <div class="text-gray-500">
                <a class="text-green-700 hover:text-green-500"
                  :href="`/documents/quote/${purchase_order.purchase_quote.purchase_doc}`" target="_blank">
                  Previsualizar
                </a>
              </div>
            </div>
