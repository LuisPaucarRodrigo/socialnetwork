                    ...
                    <tr v-for="purchase in purchases.data" :key="purchase.id" class="text-gray-700">
                        ...
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <div class="flex space-x-3 justify-center">
                                ...
                                <Link v-if="purchase.project == null && purchase.state != 'Aceptado'" class="text-blue-900 whitespace-no-wrap"
                                ...
                                <button v-if="purchase.state != 'Aceptado'" type="button" @click="confirmPurchasesDeletion(purchase.id)"
                                    class="text-blue-900 whitespace-no-wrap">
