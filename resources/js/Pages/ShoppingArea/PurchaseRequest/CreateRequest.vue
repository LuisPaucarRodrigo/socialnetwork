                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <!-- <div class="sm:col-span-3">
                            <InputLabel for="project_name" class="font-medium leading-6 text-gray-900">Proyecto</InputLabel>
                            <div class="mt-2">
                                <TextInput type="text" v-model="form.project_name" id="project_name" autocomplete="given-name"
                        ...
                        <div class="sm:col-span-4">
                            <InputLabel for="product_description" class="font-medium leading-6 text-gray-900">Descripcion de Solicitud</InputLabel>
                            <div class="mt-2">
