            ...
            <dl class="divide-y divide-gray-100">
                ...
                <div class="px-4 py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    ...
                    <dd class="mt-1 text-sm leading-6 sm:col-span-2 sm:mt-0">
                        <span :class="`uppercase inline-flex items-center gap-x-1 py-0 px-3 text-sm rounded-full font-medium ${setBadgeColor(details.due_date, details.state)} text-white`">
            ...
            <div class="col-span-6 xl:col-span-4 overflow-x-auto mt-8 ring-1 ring-gray-300 rounded-lg shadow-sm">
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(item, index) in (details.products)" :key="index" class="text-gray-700 hover:bg-gray-200 bg-white">
