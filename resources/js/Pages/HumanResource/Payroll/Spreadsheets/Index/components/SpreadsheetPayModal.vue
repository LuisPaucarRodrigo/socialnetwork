                        ...
                        <div class="overflow-auto rounded-lg shadow-sm">
                            <table class="w-full ">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="text-xs text-gray-600 bg-gray-100 py-1">
                                            <label :for="`mod-check-all`"
                                                class="flex gap-2 justify-center tex-center py-1">
                                                <input @change="handleCheckAll" :id="`mod-check-all`"
                                                    :checked="selectedIds.ids.length > 0" type="checkbox" />
                                ...
                                <tbody>
                                    <tr v-for="(item, i) in form.payroll_detail_expenses" :key="i">
                                        <td class="text-xs text-gray-800 bg-white border-b border-gray-200 px-2 py-1">
                                            <label :for="`mod-check-${i}`" class="block px-2 py-3">
                                                <input v-model="selectedIds.ids" :value="i" :id="`mod-check-${i}`"
                                                    type="checkbox" />
                                            </label>
                                        </td>
                                        <td class="text-xs text-gray-800 bg-white border-b border-gray-200 px-2 py-1">{{
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm text-gray-800 bg-white px-2 py-1 text-right">
                                            S/. {{parseFloat(form.payroll_detail_expenses.reduce((a, b) => a + b.amount,
                                                0)).toFixed(2)}}</td>
                                        <td></td>
                                    </tr>
                                </tbody>
