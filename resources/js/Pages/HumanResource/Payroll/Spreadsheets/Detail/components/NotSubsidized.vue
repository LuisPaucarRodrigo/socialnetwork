...
const listSuspensionType = [
    { id: 1, name: "01-SP. SANCIÓN DISCIPLINARIA" },
    { id: 2, name: "02-SP. EJERCICIO DERECHO HUELGA" },
    { id: 3, name: "03-SP. DETENCIÓN DEL TRABAJADOR" },
    { id: 4, name: "04-SP. INHAB. ADMINIST, JUDICIAL O PENA PRIVATIVA" },
    { id: 5, name: "05-SP. PERMISO, LICENCIA U OTROS SIN GOCE DE HABITA" },
    { id: 6, name: "06-SP. CASO FORTUITO O FUERZA MAYOR" },
    { id: 7, name: "07-SP. FALTA NO JUSTIFICADA" },
    { id: 8, name: "08-SP. POR TEMPORADA O INTERMITENTE" },
    { id: 10, name: "10-SP. SENTENCIA TERR, NARC,CORRUP Y VIOLAC" },
    { id: 11, name: "11-SP. IMPOSICIÓN MEDIDA CAUTELAR" },
]
