<template>
    ...
    <AuthenticatedLayout :redirectRoute="'document.rrhh.status'">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-10">
            <div
                class="col-span-1 min-w-full rounded-lg shadow bg-white p-6 gap-6"
            >
            ...
            <div
                class="col-span-1 sm:col-span-3 min-w-full rounded-lg shadow bg-white p-6 grid grid-cols-1 sm:grid-cols-3 gap-2"
            >
                <template v-for="sec in sections">
                    <div
                        v-for="(sub, i) in sec.subdivisions"
                        :key="i"
                    ...
                    >
                        ...
                        <div 
                        :class="['flex gap-3 justify-center items-center h-12 ',
                        {
                        ...
                        >
                            ...
                            >
                                <span
                                    class="relative inline-flex rounded-full h-3 w-3 bg-fuchsia-500 cursor-pointer"
                                >
                                </span>
                            </div>
                            <p
