<template>
    ...
    <AuthenticatedLayout :redirectRoute="'documents.index'">
        ...
        <div class="flex w-full mt-5">
            <!-- Tabla -->
            <div class="w-[78%] overflow-x-auto">
                ...
                <div class="max-h-[77vh] overflow-y-auto border rounded-md">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr
                                v-for="document in dataToRender.data"
                                :key="document.id"
                            >
                                <td
            ...
            <div class="w-[20%] p-4 space-y-4">
                ...
                >
                    ...
                    >
                        <div class="flex items-center space-x-2">
                            <!-- SOLO el checkbox controla selección + apertura -->
                            <input
                                type="checkbox"
                                :checked="
                                    filterForm.sections.includes(section.id)
                                "
                                @change.stop="handleSectionCheckbox(section)"
                                class="form-checkbox h-4 w-4 text-indigo-600"
                            />
                            <!-- El texto NO hace toggle de selección -->
                    ...
                    >
                        <div
                            ...
                            @click="handleSubdivisionToggle(section.id, sub.id)"
                        >
                            <input
                                type="checkbox"
                                :checked="
                ...
                <div class="flex gap-3">
                    <button
                        @click="cleanFilters"
                        class="w-full mt-4 bg-gray-400 text-white py-2 px-4 rounded-md text-sm hover:bg-gray-500 transition"
                    >
                        Limpiar
                    </button>
                    <button
                        @click="applyFilters"
                        class="w-full mt-4 bg-indigo-600 text-white py-2 px-4 rounded-md text-sm hover:bg-indigo-700 transition"
                    >
                        Aplicar
                    </button>
                </div>
