...
import { ShowIcon, EditIcon, DeleteIcon, DownArrowIcon, UpArrowIcon, DocumentsIcon } from '@/Components/Icons';

const { formSearch, cars, cost_line, openEditFormCar, openformDocument, openModalDeleteCars, openModalDeleteChangelog
} = defineProps({
    formSearch: Object,
    cars: Object,
    cost_line: Object,
