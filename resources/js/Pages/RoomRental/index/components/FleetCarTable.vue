                ...
                <tr>
                    ...
                    <TableRow :colspan="2" v-permission-or="[
                        ...
                        <div class="flex space-x-3 justify-center">
                            ...
                            <a v-permission-or="['room_actions', 'room_actions_manager']"
                                :href="route('room.rental.show_checklist', { car: car.id })">
                                <ListIcon />
                            </a>
...
async function validateRegister(changelog_id, is_accepted) {
    const url = route("room.rental.show_checklist.accept_or_decline", {
