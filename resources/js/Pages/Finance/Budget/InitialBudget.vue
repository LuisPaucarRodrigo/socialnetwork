<template>
    ...
    <AuthenticatedLayout>
                ...
                <div class="p-6">
                    ...
                    <form @submit.prevent="submit2">
                        <div class="mb-4">
                            ...
                            <input type="number" disabled readonly step="0.01" id="initial_budget" name="initial_budget" :value="budgetUpdate ? props.budgetUpdate.new_budget : props.project.initial_budget" required class="mt-1 p-2 border rounded-md w-full">
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" id="initial_budget" name="initial_budget"
                                v-model="form2.difference" required class="mt-1 p-2 border rounded-md w-full">
                        </div>
                        <div class="mb-4">
        ...
        <div class="min-w-full overflow-x-auto rounded-lg shadow">
          ...
          <tbody>
            <!-- Iterar sobre las actualizaciones del presupuesto -->
...
watch(() => form2.difference, (newVal, oldVal) => {
    const diffValue = newVal !== '' ? newVal : 0; // Si diff es null, asigna 0
    const initialBudget = props.project.initial_budget || 0; // Si initial_budget es null, asigna 0
