              ...
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody>
                  <tr v-for="(item, index) in newEquipments" :key="index" class="text-gray-700">
                    ...
                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">
                      <button @click.prevent="openSerieModal(item)" class="text-green-600 hover:underline mr-2">
                        <ShowIcon />
                      </button>
                    </td>
                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">
                      <div class="flex items-center">
                        <button @click.prevent="delete_equipment(index)">
                          <DeleteIcon />
                        </button>
                      </div>
                    </td>
                ...
                <tbody>
                  <tr v-for="(item, index) in equipmentForm.series" :key="index" class="text-gray-700">
                    ...
                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-right">
                      <button @click.prevent="removeSerie(index)">
                        <DeleteIcon />
                      </button>
                    </td>
                  </tr>
