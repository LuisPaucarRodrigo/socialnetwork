    ...
    <AuthenticatedLayout :redirectRoute="{route: 'huawei.inventory.show', params: {warehouse: 'Claro'}}">
                ...
                <div>
                    <div class="overflow-x-auto mt-3 h-[85vh]">
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr
                                    ...
                                    <th
                                        ...
                                        <TableAutocompleteFilter labelClass="text-[11px]" label="N° de Pedido"
                                            :options="props.order_numbers" v-model="filterForm.selectedOrderNumbers
                                                " width="w-100" />
                                    </th>
                                    <th
                                        class="border-b-2 border-gray-200 bg-gray-100 px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600 text-center">
                            ...
                            <tbody>
                                <tr v-for="item in dataToRender.data" :key="item.id" class="text-gray-700">
                                    <td
        ...
        <Modal :show="guideModal" :closeable="true">
            <div class="p-6">
                ...
                <form @submit.prevent="assignGuide" class="grid grid-cols-2 gap-3">
                    <!-- Tercera Fila -->
                    <div class="col-span-2 grid grid-cols-2 gap-3">
                        <div class="col-span-2">
                            <InputLabel class="mb-1" for="guide_number">N° de Guía</InputLabel>
                            <input type="text" id="guide_number" v-model="form.guide_number"
                        ...
                        <div class="col-span-2">
                            <InputLabel class="mb-1" for="entry_date">Fecha de Guía</InputLabel>
                    ...
                    <div class="col-span-2 mt-6 flex items-center justify-end gap-x-6">
                        <SecondaryButton @click="closeGuideModal">Cancelar</SecondaryButton>
