                                ...
                                <template #content class="origin-left">
                                    <div>
                                        ...
                                        <div class="dropdown" v-if="props.equipment">
                                            <div class="dropdown-menu">
                                                <Link
                                                    :href="route('huawei.inventory.show', { warehouse: props.warehouse })"
                                                    type="button"
                                                    class="dropdown-item block w-full text-left px-4 py-2 text-sm text-black-700 hover:bg-indigo-600 hover:text-white focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                                Materiales
                                                </Link>
                                                <Link :href="route('huawei.inventory.refunds', { warehouse: 'Claro' })"
                                                    type="button"
                                                    class="dropdown-item block w-full text-left px-4 py-2 text-sm text-black-700 hover:bg-indigo-600 hover:text-white focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                                Devoluciones
                                                </Link>
                                                <a :href="route('huawei.inventory.general.equipments', { prefix: 'Claro' })"
                                                    type="button"
                                                    class="dropdown-item block w-full text-left px-4 py-2 text-sm text-black-700 hover:bg-indigo-600 hover:text-white focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                                    General
                                                </a>
                                        ...
                                        <div class="dropdown" v-else>
                                            <div class="dropdown-menu">
                                                <Link
                                                    :href="route('huawei.inventory.show', { warehouse: props.warehouse, equipment: 1 })"
                                                    type="button"
                                                    class="dropdown-item block w-full text-left px-4 py-2 text-sm text-black-700 hover:bg-indigo-600 hover:text-white focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                                Equipos
                                                </Link>
                ...
                <div v-if="props.equipment">
                    <div class="overflow-x-auto mt-3">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody>
                                <tr v-for="item in (props.search ? props.equipments : equipments.data)" :key="item.id"
                                    class="text-gray-700">
                                    <td
                                    ...
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">{{
                                        item.claro_code }}</td>
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">{{
                                        item.brand_model.brand.name }}</td>
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">{{
                                        item.brand_model.name }}</td>
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">{{
                                    ...
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">
                                        <div class="flex items-center">
                                            <Link
                                                :href="route('huawei.inventory.show.details', { id: item.id, equipment: 1 })">
                                            <ShowIcon />
                                            </Link>
                                        </div>
                                    </td>
                ...
                <div v-else>
                    <div class="overflow-x-auto mt-3">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody>
                                <tr v-for="item in (props.search ? props.materials : materials.data)" :key="item.id"
                                    class="text-gray-700">
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">{{
                                        item.name }}
                                    </td>
