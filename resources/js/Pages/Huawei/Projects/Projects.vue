            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row gap-4 w-full justify-between items-center">
                    <div class="flex gap-4 items-center justify-center sm:justify-start">
                        ...
                        <Link v-permission="'huawei_projects_add'" v-if="props.status == '1'"
                            :href="route('huawei.projects.create')" type="button"
                        ...
                        <Link v-if="props.status == '1'" :href="route('huawei.projects', {
                            status: '3',
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 items-center justify-center sm:justify-start">
                        ...
                        <select v-model="selectedPrefix" id="code" @change="changePrefix($event.target.value)"
                            ...
                            <option v-for="operator in props.operators" :value="operator">
                                {{ operator }}
                            </option>
                        </select>
                    </div>
                ...
                <div v-for="item in props.projects" :key="item.id"
                    ...
                    <div class="grid grid-cols-2">
                        ...
                        <div class="inline-flex justify-end items-start gap-x-2">
                            ...
                            <Link v-if="item.status" :href="route('huawei.projects.toupdate', {
                    ...
                    <div class="text-gray-500 text-sm mt-1">
                        <div class="grid grid-cols-1 gap-y-1">
                            ...
                            <Link :href="route('huawei.projects.resources', {
                                huawei_project: item.id,
                            })
                                " class="text-blue-600 underline whitespace-no-wrap hover:text-purple-600">
                            Asignar Productos
                            </Link>
                            <Link :href="route('huawei.projects.earnings', {
                                huawei_project: item.id,
                            })
                                " class="text-blue-600 underline whitespace-no-wrap hover:text-purple-600">
                            Ingresos Proyectados
                            </Link>
                            <Link :href="route('huawei.projects.realearnings', {
                                huawei_project: item.id,
                            })
                                " class="text-blue-600 underline whitespace-no-wrap hover:text-purple-600">
                            Ingresos Actuales
                            </Link>
                            <Link :href="route('huawei.projects.liquidations', {
                                huawei_project: item.id,
                            })
                                " class="text-blue-600 underline whitespace-no-wrap hover:text-purple-600">
                            Liquidaciones
                            </Link>
                            <Link :href="route('huawei.projects.balance', {
                                huawei_project: item.id,
                            })
                                " class="text-blue-600 underline whitespace-no-wrap hover:text-purple-600">
                            ...
                            <a v-if="item.pre_report"
                                class="text-blue-600 underline whitespace-no-wrap hover:text-purple-600" :href="route('huawei.projects.prereport', {
                                    huawei_project: item.id,
                                })
                                    " target="_blank">
                                Reporte
            ...
            <div class="p-6">
                ...
                <div class="mt-6 flex space-x-3 justify-end">
                    ...
                    <button
                        ...
                        type="button" @click="cancel_project()">
                        Aceptar
                    </button>
                </div>
            </div>
        ...
        <Modal :show="resumeModal" :maxWidth="'md'">
            ...
            <div class="p-6">
                ...
                <div class="mt-6 flex space-x-3 justify-end">
                    ...
                    <button
                        class="rounded-md bg-indigo-600 px-2 py-2 whitespace-no-wrap text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:border-transparent"
                        type="button" @click="resume_project()">
                        Aceptar
                    </button>
                </div>
            </div>
