                    ...
                    <div class="border-b border-gray-900 pb-12">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <select required id="prefix" v-model="form.macro_project"
                                        ...
                                        <option v-for="macro in props.macro_projects" :value="macro">
                                            {{ macro }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    ...
                                    " v-model="form.prefix"
                                        ...
                                        <option v-for="op in props.operators" :value="op">
                                            {{ op }}
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div v-else class="grid grid-cols-1 md:grid-cols-2 mt-5 gap-y-2 text-lg">
                            ...
                            <div class="flex gap-2 items-start">
                                ...
                                <div>
                                    <textarea id="editName" v-model="form.description"
                        ...
                        <div class="flex flex-space gap-2">
                            ...
                            <button type="button" @click="createAssignation" class="px-1">
                                <PlusCircleIcon />
                            </button>
                        </div>
                        <TransitionGroup tag="div" enter-active-class="transition duration-300 ease-out"
                            ...
                            <div v-for="(
assignation, index
                                ) in form.assignations" :key="index"
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex gap-5 items-center">
                                        ...
                                        <button v-if="!assignation.id" type="button" @click="deleteAssignation(index)">
                                            <DeleteIcon />
                                        </button>
                                    </div>
                                    <div class="flex flex-space gap-2">
                                        <button type="button" @click="toggleAssignation(index)">
                                            <UpArrowIcon v-if="isOpen(index)" />
                                ...
                                <Transition enter-active-class="transition duration-300 ease-out"
                                    ...
                                    <div v-if="isOpen(index)">
                                        <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6 mt-5">
                                            <div class="sm:col-span-3">
        ...
        index
                        ...
                        <div>
                            ...
                            <div class="flex flex-space gap-2">
                                ...
                                <button type="button" @click="open_schedule" class="px-1">
                                    <PlusCircleIcon />
                                </button>
                            </div>
                            <div class="mt-5">
                                <div class="overflow-x-auto mt-3">
                                    <table class="w-full whitespace-no-wrap">
                                        ...
                                        <tbody>
                                            <template v-for="(
item, index
                                                ) in form.schedule" :key="index" class="text-gray-700">
                                                <tr>
                                                    <td
                                                        class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">
                                                        {{ index + 1 }}
                                ...
                                <div>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <datalist id="price_guide_list">
                                            <option v-for="pg in props.price_guides" :key="pg.id" :value="pg.code">
                                                {{ pg.description }}
                                            </option>
                                        </datalist>
                        ...
                        <div class="space-y-12">
                            <div class="border-b grid grid-cols-1 md:grid-cols-2 gap-6 border-gray-900/10 pb-12">
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <div class="mt-2">
                                        <select id="employee" v-model="scheduleForm.employees" multiple
...
employee, index
                                        ...
                                        <InputError :message="scheduleForm.errors.employees
                                            " />
                                    </div>
                                </div>
                            </div>
