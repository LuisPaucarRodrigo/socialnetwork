                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div :class="form.concept === '14' ? 'col-span-1' : 'col-span-1 md:col-span-2'">
                                    <InputLabel for="concept" class="font-medium leading-6 text-gray-900">Concepto
                                    </InputLabel>
                                    <div class="mt-2">
                                        <select required id="concept" v-model="form.concept"
                                            ...
                                            <option value="6">Traslado entre establecimientos de una misma empresa
                                            </option>
                                ...
                                <div v-if="form.concept === '14'" class="col-span-1">
                                    <InputLabel for="additional" class="font-medium leading-6 text-gray-900">Especifique
                                    </InputLabel>
                                    <div class="mt-2">
