              ...
              <tr v-for="item in (props.search ? props.quick_materials : quick_materials.data)" :key="item.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center">
                  <div class="flex gap-2 justify-center items-center">
                    <Link class="text-green-600 hover:underline"
                      :href="route('huawei.quickmaterials.details', { material_id: item.id })">
                    <ShowIcon />
                    </Link>
          ...
          <form @submit.prevent="isCreateModalOpen ? submit(false) : submit(true)">
            <div class="space-y-12">
              <div class="border-b border-gray-900/10 pb-12">
                <div>
                  <InputLabel for="description">{{ isCreateModalOpen ? 'Agregar Material:' : 'Actualizar Material' }}
                  </InputLabel>
                  <div class="mt-2">
      ...
      <Modal :show="showConfirmNameModal" :maxWidth="'sm'">
        <div class="p-6">
          ...
          <p class="mt-1 text-sm text-gray-600 text-wrap">
            Actualmente, hay un material que tiene un nombre similar al que esta intentando registrar: <span
              class="font-black">{{ foundName }}</span>. </p>
          <div class="space-y-12">
