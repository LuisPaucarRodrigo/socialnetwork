        ...
        <table class="w-full whitespace-no-wrap">
          ...
          <tbody>
            <tr v-for="(item, index) in huaweiData.data" :key="index" class="text-gray-700">
              ...
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">{{ item.date ? formattedDate(item.date) :
                ''
              }}</td>
          ...
          <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12 grid grid-cols-2 gap-6">
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="number" step="0.01" v-model="filterForm.minValue"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="number" step="0.01" v-model="filterForm.maxValue"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <!-- General Status -->
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <select v-model="filterForm.generalStatus"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600">
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="filterForm.codsap"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="filterForm.serie"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="filterForm.period"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="filterForm.hire"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="filterForm.ocPap"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="filterForm.sites"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
          ...
          <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12 grid grid-cols-2 gap-6">
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="date" v-model="editingForm.date"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                <InputLabel for="codsap">CODSAP</InputLabel>
                <div class="mt-2">
                  <input type="text" v-model="editingForm.codsap"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="editingForm.description"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                <InputLabel for="serie">Serie</InputLabel>
                <div class="mt-2">
                  <input type="text" v-model="editingForm.serie"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                <InputLabel for="period">Periodo</InputLabel>
                <div class="mt-2">
                  <input type="text" v-model="editingForm.period"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                <InputLabel for="hire">Contrata</InputLabel>
                <div class="mt-2">
                  <input type="text" v-model="editingForm.hire"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="editingForm.oc_pap"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                <InputLabel for="sites">Sites</InputLabel>
                <div class="mt-2">
                  <input type="text" v-model="editingForm.sites"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                <InputLabel for="generalStatus">Estatus General</InputLabel>
                <div class="mt-2">
                  <select v-model="editingForm.general_status"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600">
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="number" step="0.01" v-model="editingForm.monetary_value"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
              ...
              <div class="col-span-1">
                ...
                <div class="mt-2">
                  <input type="text" v-model="editingForm.observation"
                    class="block w-full py-1.5 rounded-md sm:text-sm form-input focus:border-indigo-600" />
                </div>
              </div>
