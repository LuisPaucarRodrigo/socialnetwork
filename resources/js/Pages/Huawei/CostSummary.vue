<template>
    ...
    <AuthenticatedLayout
      ...
      <Link :href="route('huawei.projects.additionalcosts', {huawei_project: huawei_project.id})" type="button" class="inline-block mb-5 mx-2 rounded-md bg-indigo-600 px-4 py-2 text-center text-sm text-white hover:bg-indigo-500 whitespace-nowrap">
        Gastos Variables
      </Link>
      <Link :href="route('huawei.projects.staticcosts', {huawei_project: huawei_project.id})" type="button" class="inline-block mb-5 mx-2 rounded-md bg-indigo-600 px-4 py-2 text-center text-sm text-white hover:bg-indigo-500 whitespace-nowrap">
        Gastos Fijos
      </Link>
