  ...
  <AuthenticatedLayout
	...
	V416z" />
		...
		C321.28,339.632,268.064,351.008,272.032,314.672z" />
                ...
                <svg v-if="props.folder.archive_type === 'Power Point'" height="30px" width="30px" version="1.1"
	...
	V416z" />
		...
		h-21.232v64.608c0,11.12-16.896,11.392-16.896,0V311.472z" />
              ...
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center" colspan="2">
              ...
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm text-center">
                <div
                  v-if="archive.type !== 'stable' && archive.approve_status && ![1, 3, 5].includes(archive.observation_state)"
              ...
              <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                <button v-if="archive.type !== 'stable'" type="button" @click="toggleDetails(archive)"
                  ...
                  <svg v-if="archiveRow[0]?.archive_id !== archive.id" xmlns="http://www.w3.org/2000/svg" fill="none"
