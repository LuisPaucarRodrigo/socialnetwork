            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead>
                        ...
                        >
                            <th
                                class="sticky left-0 z-10 px-1 border border-gray-300 bg-gray-100 text-center text-xs font-semibold uppercase tracking-wider text-gray-600"
                            ></th>
                            <th
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            class="sticky left-0 z-10"
                                :class="[
                                    {
                                        'bg-red-500': item.state == 'PENDIENTE',
                                        'bg-amber-500':
                                            item.state == 'GESTIONADO',
                                        'bg-green-500':
                                            item.state == 'SOLUCIONADO',
                                    },
                                ]"
                            ></td>
                            <td
                                ...
                                :class="[
                                    ...
                                    item?.id ? '' : 'h-16',
                                    b_item.editable ? 'cursor-pointer' : '',
                                ]"
                                @dblclick="
                                    b_item.editable
