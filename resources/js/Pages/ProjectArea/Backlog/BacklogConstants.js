const backlogHeaders = [
    ...
    { headerName: "Fecha de Inicio de Compromiso", headerRef: "thStartCommitDate" },
...
const backlogItems = [
    ...
    { editable: true,  propType: "select" , propName: "state", 
      options: ['', 'PENDIENTE', 'GESTIONADO', 'SOLUCIONADO']},
    ...
    { editable: true,  propType: "text" , propName: "responsible_cicsa"},
    { editable: true,  propType: "select" , propName: "criticity", options: ['', '1', '2', '3']},
    { editable: true,  propType: "select" , propName: "conproco_area", options: ['','INFRAESTRUCTURA', 'ESPECIALISTAS', 'LOGÍSTICA', 'PLANIFICACIÓN', 'PRL', 'GERENCIA DEL PROYECTO', 'CAMPO']},
    { editable: true,  propType: "select" , propName: "origin_event", options: ['', 'MP', 'MC', 'CLIENTE']},
