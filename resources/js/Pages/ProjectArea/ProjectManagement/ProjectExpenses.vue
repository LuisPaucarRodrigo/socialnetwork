<template>
    ...
    >
        ...
        <!-- componenteeeeeeeeee -->
        <MarginProfit v-if="project.cost_center_id == 1"
            :expensesVariables="{
                incomeNoTaxes: Number(project?.preproject?.quote?.total_amount?.toFixed(2)),
                incomeTaxes: Number(project?.preproject?.quote?.total_amount.toFixed(2))*1.18,
                staticCosts,
                additionalCosts,
            }"
        />
                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="tabular-nums">
                                <tr class="text-gray-700">
                                    ...
                                    >
                                        S/. {{ (Number(project?.preproject?.quote?.total_amount.toFixed(2))*1.18).toFixed(2) }}
                                    </td>
                                </tr>
                                <tr class="text-gray-700">
                                    <td
