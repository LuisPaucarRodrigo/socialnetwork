                        ...
                        >
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    ...
                                    <InputError
                                        :message="form.errors.preproject_id"
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            >
                                <div class="flex gap-2">
                                    <InputLabel
                                        for="trainings"
                                        class="font-medium leading-6 text-gray-900"
                                        >Miembros del equipo al proyecto
                                    </InputLabel>
                                    <button
                                        @click="showToAddEmployee"
                                        type="button"
                                    >
                                        <UserPlusIcon
                                            class="text-indigo-800 h-6 w-6 hover:text-purple-400"
                                        />
                                    </button>
                                </div>
                                <br />
                                ...
                                <div class="grid sm:grid-cols-2 gap-8">
                                    <div class="mt-2">
                                        ...
                                        >
                                            <p
                                                class="text-sm col-span-7 line-clamp-2"
                                            >
                                                {{ member.name }}
                                                {{ member.lastname }}:
                                                {{ member.pivot.charge }}
                                            ...
                                            <div
                                                class="border-b col-span-8 border-gray-900/10"
                                            ></div>
                                        </div>
                                    </div>
                                    <div class="mt-2">
