<template>
    ...
    <AuthenticatedLayout :redirectRoute="'customers.index'">
            ...
            <div class="p-6">
                ...
                <div class="space-y-12">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                        <input type="number" v-model="form.ruc" id="ruc" max="11"
                    ...
                    <div>
                        <InputLabel for="business_name" class="font-medium leading-6 text-gray-900 mt-3">Razón Social</InputLabel>
                        <div class="mt-2">
                    ...
                    <div>
                        <InputLabel for="address" class="font-medium leading-6 text-gray-900 mt-3">Dirección</InputLabel>
                        <div class="mt-2">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <SecondaryButton @click="create_customer ? close_add_customer() : close_edit_customer()"> Cancelar </SecondaryButton>
                        <button type="submit" :class="{ 'opacity-25': form.processing }"
                        class="rounded-md bg-indigo-600 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ create_customer ? 'Guardar' : 'Actualizar'}}</button>
                    </div>
                    </div>
                </div>
                </form>
        ...
        <ConfirmDeleteModal :confirmingDeletion="confirmingDocDeletion" itemType="Cliente" :deleteFunction="deleteCustomer"
