<template>
    ...
    <AuthenticatedLayout :redirectRoute="'preprojects.titles'">
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <button @click="add_title" type="button"
        ...
        <Modal :show="create_title || edit_title">
            <div class="p-6">
                ...
                <div class="space-y-12">
                    ...
                    <div>
                        <InputLabel for="title" class="font-medium leading-6 text-gray-900 mt-3">Título</InputLabel>
                        <div class="mt-2">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <SecondaryButton @click="create_title ? close_add_title() : close_edit_title()"> Cancelar </SecondaryButton>
                        <button type="submit" :class="{ 'opacity-25': form.processing }"
                        class="rounded-md bg-indigo-600 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ create_title ? 'Guardar' : 'Actualizar'}}</button>
                    </div>
                    </div>
                </div>
                </form>
