        ...
        <Modal :show="create_code || edit_code">
            <div class="p-6">
                ...
                <div class="space-y-12">
                    ...
                    <div>
                        <InputLabel for="code" class="font-medium leading-6 text-gray-900 mt-3">Código</InputLabel>
                        <div class="mt-2">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <SecondaryButton @click="create_code ? close_add_code() : close_edit_code()"> Cancelar </SecondaryButton>
                        <button type="submit" :class="{ 'opacity-25': form.processing }"
                        class="rounded-md bg-indigo-600 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ create_code ? 'Guardar' : 'Actualizar'}}</button>
                    </div>
                    </div>
                </div>
                </form>
