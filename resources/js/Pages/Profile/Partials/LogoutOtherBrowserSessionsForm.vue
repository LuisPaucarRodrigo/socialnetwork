    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                ...
                exhaustiva. Si cree que su cuenta ha sido comprometida, también debe actualizar su contraseña. </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                <template #title>
                    Cerrar sesión en otras sesiones del navegador </template>

                <template #content>
                    Ingrese su contraseña para confirmar que desea cerrar sesión en sus otras sesiones de navegador en todos
                    sus dispositivos.
                    <div class="mt-4">
                ...
                <template #footer>
                    ...
                    <PrimaryButton class="ml-3" :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
                        ...
                        Cerrar sesión en otras sesiones del navegador </PrimaryButton>
                </template>
            </DialogModal>
        </template>
    </ActionSection>
