    ...
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && !confirming" class="text-lg font-medium text-gray-900">
                Ha habilitado la autenticación de dos factores. </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-gray-900">
                Termine de habilitar la autenticación de dos factores. </h3>

            <h3 v-else class="text-lg font-medium text-gray-900">
                No ha habilitado la autenticación de dos factores. </h3>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p v-if="confirming" class="font-semibold">
                            Para terminar de habilitar la autenticación de dos factores, escanee el siguiente código QR usando el teléfono
                            aplicación de autenticación o ingrese la clave de configuración y proporcione el código OTP generado.
                        </p>

                        <p v-else>
                            La autenticación de dos factores ahora está habilitada. Escanea el siguiente código QR usando tu teléfono
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            Guarde estos códigos de recuperación en un administrador de contraseñas seguro. Se pueden utilizar para recuperar el acceso a
                ...
                <div v-else>
                    ...
                    <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
                        <SecondaryButton v-if="recoveryCodes.length > 0 && !confirming" class="mr-3">
                            Regenerar códigos de recuperación                        </SecondaryButton>
                    </ConfirmsPassword>

                    <ConfirmsPassword @confirmed="showRecoveryCodes">
                        <SecondaryButton v-if="recoveryCodes.length === 0 && !confirming" class="mr-3">
                            Mostrar códigos de recuperación                        </SecondaryButton>
                    </ConfirmsPassword>
