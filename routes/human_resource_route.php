...
Route::middleware('permission:HumanResourceManager')->group(function () {
    ...
    Route::post('/document_sections/{sectionId}/zipdownload', [DocumentController::class, 'downloadSectionDocumentsZip'])->name('documents.zipSection');
    ...
    Route::post('/document_sections/{section}/subdivisions/{subdivisionId}/zipdownload', [DocumentController::class, 'downloadSubdivisionDocumentsZip'])->name('documents.zipSubdivision');
