...
Route::middleware('permission:ProjectManager|Project')->group(function () {
    ...
    Route::get('/projectPext/additionalOrFixed/expenses/general/{fixedOrAdditional}/index', [PextController::class, 'additional_expense_index_general'])->name('pext.additional.expense.general.index');
